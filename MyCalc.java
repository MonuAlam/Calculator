...
if(e.getSource()==b2){
zt=l1.getText();
z="2"+zt;//when enter multiple 2 then it work ek baar me ek zt aayega or 2 ke sath concatinate kar ke show kar denge or aaise hi jitne baar 2 enert hoga usse show karega
l1.setText(z);
}
if(e.getSource()==b3){
  zt=l1.getText();
